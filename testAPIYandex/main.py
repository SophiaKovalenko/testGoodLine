...
*Используется ключ: {6e715e39-9e14-4981-9e3c-a4a3d5b5251c}
'''
...
def nearest_stationsGet(payload_nearest_stations):
    ...
    print('------------------------------')
    print('def nearest_stationsGet(): Список ближайших станций')
...
def nearest_nearest_settlementGet(payload_nearest_settlement):
    ...
    print('------------------------------')
    print('def nearest_nearest_settlementGet(payload_nearest_settlement): Ближайший город к указанной точке')
    ...
    print(f"В радиусе {payload_nearest_settlement['distance']}км (от Б15) Ближайший город:{name_settlement}, его центр на расстоянии: {round(distance,4)}км")


def searchGet(payload_search):
    # Расписание рейсов между станциями
    print('------------------------------')
    print('def searchGet(payload_search): Расписание рейсов между станциями')
